...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-12 text-center" style="font-weight:bold; font-size:22px; margin-top: 2rem;">Cargar Multiples GIFS</div>
			<div class="col-12 text-center mt-3">
				<form id="formulario1" method="post" action="#" enctype="multipart/form-data">
					<input type="hidden" id="condicion" name="condicion" value="subir3">
					<div class="row">
						<div class="col-10">
