...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-12 text-center" style="font-weight:bold; font-size:22px; margin-top: 2rem;">Cargar 1 Video a la vez</div>
			<div class="col-12 text-center mt-3">
				<form id="formulario1" method="post" action="#" enctype="multipart/form-data">
					<input type="hidden" id="condicion" name="condicion" value="subir2">
					<div class="row">
						<div class="col-10">
